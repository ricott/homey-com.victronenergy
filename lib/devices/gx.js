...
const GX = Object.freeze({
    ...
    essMode: new ModbusRegistry(setting.READING, config.gxSystemUnitCode, 2902, 1, type.uint16_1, 'ESS Mode'),
    ...
    maxDischargePower: new ModbusRegistry(setting.READING, config.gxSystemUnitCode, 2704, 1, type.uint16_01, 'ESS max discharge power'),
    ...
    // Grid
    totalEnergyForward: new ModbusRegistry(setting.READING, config.gxGridUnitCode, 2634, 2, type.uint32_100, 'Total Energy from net'),
    totalEnergyReverse: new ModbusRegistry(setting.READING, config.gxGridUnitCode, 2636, 2, type.uint32_100, 'Total Energy to net'),
    //Lots of alarms
