...
class VictronGX {
  ...
  writeGridSetpoint(power) {
    ...
    return this.modbusClients[config.gxSystemUnitId].writeMultipleRegisters(2700, buffer)
      .then((result) => {
        return true;
      }).catch(reason => {
  ...
  limitInverterPower(power) {
    return this.modbusClients[config.gxSystemUnitId].writeSingleRegister(2704, power * 0.1)
      .then((result) => {
        return true;
      }).catch(reason => {
        return Promise.reject(reason);
  ...
  limitChargerCurrent(current) {
    ...
    return this.modbusClients[config.gxSystemUnitId].writeMultipleRegisters(2705, buffer)
      .then((result) => {
        return true;
      }).catch(reason => {
        return Promise.reject(reason);
  ...
  limitGridFeedInPower(power) {
    ...
    return this.modbusClients[config.gxSystemUnitId].writeMultipleRegisters(2706, buffer)
      .then((result) => {
        return true;
      }).catch(reason => {
        return Promise.reject(reason);
  ...
  disableCharger() {
    return this.modbusClients[config.gxSystemUnitId].writeSingleRegister(2701, 0)
      .then((result) => {
        return true;
      }).catch(reason => {
        return Promise.reject(reason);
  ...
  enableCharger() {
    return this.modbusClients[config.gxSystemUnitId].writeSingleRegister(2701, 100)
      .then((result) => {
        return true;
      }).catch(reason => {
        return Promise.reject(reason);
  ...
  disableInverter() {
    return this.modbusClients[config.gxSystemUnitId].writeSingleRegister(2702, 0)
      .then((result) => {
        return true;
      }).catch(reason => {
        return Promise.reject(reason);
  ...
  enableInverter() {
    return this.modbusClients[config.gxSystemUnitId].writeSingleRegister(2702, 100)
      .then((result) => {
        return true;
      }).catch(reason => {
        return Promise.reject(reason);
