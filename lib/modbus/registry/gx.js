...
const GX = Object.freeze({
    ...
    importPeakshavingCurrent: new ModbusRegistry(setting.SYSTEM, 2714, 1, type.int16_1, 'Import Peakshaving Current'),
    ...
    dynamicESSMode: new ModbusRegistry(setting.SYSTEM, 5423, 1, type.uint16_1, 'Dynamic ESS Mode'),
